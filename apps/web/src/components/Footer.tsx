        ...
        >
          ...
          >
            ...
            <div>
              ...
              >
                Your cozy desktop AI companion & 1-click time tracker. Built for focus, calm, and
                simple daily rhythm.
              </p>
            ...
            <div>
              ...
              >
                ...
                <li>
                  <a href="#stopwatch" style={{ color: 'inherit', textDecoration: 'none' }}>
                    1-Click Project Stopwatch
                  </a>
                </li>
                <li>
                  <a href="#routine" style={{ color: 'inherit', textDecoration: 'none' }}>
                    9 AM Lifestyle Rhythm
                  </a>
                </li>
                <li>
                  <a href="#capabilities" style={{ color: 'inherit', textDecoration: 'none' }}>
                    Daily Tasks & Email Nudges
                  </a>
                </li>
                <li>
            ...
            <div>
              ...
              >
                ...
                <li>
                  <a
                    href="https://github.com/manulaWithanage/mochi-companion/blob/main/LLM_ROUTER_SECURITY.md"
                    target="_blank"
                    rel="noreferrer"
                    style={{ color: 'inherit', textDecoration: 'none' }}
                  >
                ...
                <li>
                  <a
                    href="https://github.com/manulaWithanage/mochi-companion/blob/main/SYSTEM_ARCHITECTURE.md"
                    target="_blank"
                    rel="noreferrer"
                    style={{ color: 'inherit', textDecoration: 'none' }}
                  >
                ...
                <li>
                  <a
                    href="https://github.com/manulaWithanage/mochi-companion/blob/main/SCALING_STRATEGY.md"
                    target="_blank"
                    rel="noreferrer"
                    style={{ color: 'inherit', textDecoration: 'none' }}
                  >
            ...
            <div>
              ...
              >
                ...
                <li>
                  <a
                    href="https://github.com/manulaWithanage/mochi-companion/blob/main/LAUNCH_PLAN.md"
                    target="_blank"
                    rel="noreferrer"
                    style={{ color: 'inherit', textDecoration: 'none' }}
                  >
          ...
          >
            <div>
              © 2026 <strong>Mochi Companion</strong>. Developed by{' '}
              <strong>Manula Withanage</strong>.
            </div>
            <div>
      ...
      >
        ...
        <div
          style={{
            ...
            height: '120px',
            background:
              'linear-gradient(to bottom, #f8fafc 0%, rgba(248, 250, 252, 0.85) 45%, transparent 100%)',
            zIndex: 2,
            pointerEvents: 'none',
          }}
        ></div>
