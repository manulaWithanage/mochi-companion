...
export const Footer: React.FC = () => {
  ...
  return (
    <footer style={{
      ...
      {/* 📄 4 NAVIGATION COLUMNS FLOATING DIRECTLY ON TOP OF THE WHITE SKY AREA */}
      <div style={{
        position: 'relative',
        zIndex: 10,
        maxWidth: '1200px',
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '32px' }}>
          ...
          <div>
            ...
            <p style={{ fontSize: '14px', color: '#334155', lineHeight: '1.6', marginBottom: '16px', maxWidth: '280px', fontWeight: '500' }}>
          ...
          {/* Col 2: Product */}
          <div>
            <h4 style={{ fontSize: '13px', fontWeight: '800', color: '#475569', textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: '16px' }}>PRODUCT</h4>
          ...
          {/* Col 3: Open Source */}
          <div>
            <h4 style={{ fontSize: '13px', fontWeight: '800', color: '#475569', textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: '16px' }}>OPEN SOURCE</h4>
            <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '10px', fontSize: '14px', color: '#1e293b', fontWeight: '600' }}>
          ...
          {/* Col 4: Community */}
          <div>
            <h4 style={{ fontSize: '13px', fontWeight: '800', color: '#475569', textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: '16px' }}>COMMUNITY</h4>
            <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '10px', fontSize: '14px', color: '#1e293b', fontWeight: '600' }}>
      ...
      {/* Copyright bar overlaid at the bottom */}
      <div style={{
        position: 'relative',
        zIndex: 12,
        maxWidth: '1200px',
