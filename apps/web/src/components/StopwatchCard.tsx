...
export const StopwatchCard: React.FC = () => {
  ...
  return (
    <div
      ...
      style={{ padding: '24px', flex: 1, position: 'relative', overflow: 'hidden' }}
    >
      ...
      <div style={{ marginBottom: '20px' }}>
        ...
        >
          ...
          <option value="Project 1: Electron Overlay Engine">
            Project 1: Electron Overlay Engine
          </option>
          <option value="Project 2: BYOK Key Vault & Router">
            Project 2: BYOK Key Vault & Router
          </option>
        </select>
      </div>
