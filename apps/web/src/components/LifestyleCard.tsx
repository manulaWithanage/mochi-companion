...
export const LifestyleCard: React.FC = () => {
  const scheduleItems = [
    {
      time: '09:00 AM',
      label: 'Breakfast & Morning Briefing',
      status: 'completed',
      icon: '☕',
      note: 'Checked in & hydrated',
    },
    {
      time: '01:00 PM',
      label: 'Lunch & Screen Break',
      status: 'completed',
      icon: '🥗',
      note: '30-min stretch',
    },
              ...
              <div>
                <div
                  style={{
                    fontSize: '14px',
                    fontWeight: '600',
                    color: item.status === 'completed' ? 'var(--text-main)' : 'var(--text-muted)',
                  }}
                >
                  {item.label}
                </div>
                <div style={{ fontSize: '12px', color: 'var(--text-subtle)' }}>{item.note}</div>
              </div>
              <div
                style={{
                  fontSize: '12px',
